			...
			<view class="header">
				...
				<view class="signIn">
					<view class="signIn_box flex">
						<view class="signIn_info flex" @click="webself.$Router.navigateTo({route:{path:'/pages/basicinfo/basicinfo?level=staff'}})">
...
<script>
	...
	export default {
		...
		methods: {
			...
			goPage(id) {
			    if(id=="mybusiness"){
					this.$Router.navigateTo({route:{path:'/pages/staffBusiness/staffBusiness'}});
				}else if(id=="flowrecord"){
					this.$Router.navigateTo({route:{path:'/pages/flowrecord/flowrecord?level=staff'}});
				}else if(id=="commissionrecord"){
					this.$Router.navigateTo({route:{path:'/pages/commissionrecord/commissionrecord?level=staff'}});
				}
			}
		},
	};
